        ...
        <div class="wpte-pm-single-plugin-tabs">
			<aside class="wpte-pm-single-plugin-sidebar">
				...
				<ul class="wpte-pm-single-plugin-tab-button">
					...
					<li class="btn"><a href="#product"><i class="demo-icon icon-code"></i> <?php echo  esc_html__('Product', WPTE_PM_TEXT_DOMAIN); ?></a></li>
					<li class="btn"><a href="#license"><i class="demo-icon icon-status"></i> <?php echo  esc_html__('License', WPTE_PM_TEXT_DOMAIN); ?></a></li>
